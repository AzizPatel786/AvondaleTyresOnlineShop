...
namespace AvondaleTyresOnlineShop.Repository
{
    public class ProductRepository
    {
        ...
        private List<ProductModel> DataSource()
        {
            ...
            {
                new ProductModel(){Id =1, Item="MVC", Category = "Nitish" },
                new ProductModel(){Id =2, Item="Dot Net Core", Category = "Nitish" },
                new ProductModel(){Id =3, Item="C#", Category = "Monika" },
                new ProductModel(){Id =4, Item="Java", Category = "Webgentle" },
                new ProductModel(){Id =5, Item="Php", Category = "Webgentle" },
            };
        }
    }
}
